      ...
      <div style={{
        ...
        <div>
          <h2 style={{ color: '#fff', fontSize: '36px', fontWeight: '800', lineHeight: '1.2', marginBottom: '16px', letterSpacing: '-0.5px' }}>
            Controlá tus<br />finanzas con<br />claridad
          </h2>
          <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '15px', lineHeight: '1.6' }}>
            Registrá ingresos y egresos, visualizá tus gastos por categoría y alcanzá tus metas de ahorro.
          </p>
        </div>
      ...
      <div style={{ flex: '1', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
        <div style={{ width: '100%', maxWidth: '400px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            ...
            <p style={{ color: '#6b7280', fontSize: '14px' }}>Ingresá a tu cuenta para continuar</p>
          </div>
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <button
                  ...
                  style={{ position: 'absolute', right: '12px', top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: '#9ca3af', fontSize: '16px', padding: '4px', lineHeight: 1 }}
                >
                  {showPass ? '🙈' : '👁️'}
                </button>
              </div>
            ...
            <button
              ...
              style={{
                width: '100%',
                background: loading ? '#f87171' : 'linear-gradient(135deg, #E63946, #c1121f)',
                color: '#fff',
                border: 'none',
                borderRadius: '12px',
                padding: '14px',
                ...
                fontFamily: 'inherit',
                boxShadow: loading ? 'none' : '0 4px 14px rgba(230,57,70,0.4)',
                transition: 'all 0.2s',
                letterSpacing: '0.2px',
                marginTop: '4px',
              }}
